...
public interface OrderMapper {
    ...
    @Select("select sum(amount) from orders where order_time > #{startTime} and order_time < #{endTime} and status = #{status}")
    Double getAmount(int status, LocalDateTime startTime, LocalDateTime endTime);
